...
class Config(object):
	...
	BOT_TOKEN = os.environ.get("BOT_TOKEN","6149334974:AAGkah0pOKKtRDQrFTCMInzb2cZrF3AAoUw")
	BOT_USERNAME = os.environ.get("BOT_USERNAME","Akgsarchivebot")
	DB_CHANNEL = int(os.environ.get("DB_CHANNEL","-1001587463729"))
	BOT_OWNER = int(os.environ.get("BOT_OWNER", "2127437034"))
	DATABASE_URL = os.environ.get("DATABASE_URL","mongodb+srv://Akgsarchive:<password>@cluster0.qblc3to.mongodb.net/?retryWrites=true&w=majority")
	UPDATES_CHANNEL = os.environ.get("UPDATES_CHANNEL", "-1001748299287")
	LOG_CHANNEL = os.environ.get("LOG_CHANNEL","-1001762336294")
